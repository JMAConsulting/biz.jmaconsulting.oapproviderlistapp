<div class="crm-public-form-item crm-section sectorcheck">
  ...
  {if $custom_46_file.displayURL}
   <div class="file-attachment">
      <div class="crm-section file_displayURL-section file_displayURL-section"><div class="content">{ts}Uploaded file:{/ts} <a src="{$custom_46_file.displayURL}">{$custom_46_file.name}</a></div></div>
...
CRM.$(function($) {
  ...
  $('.file-attachment').insertAfter('#editrow-custom_46');
