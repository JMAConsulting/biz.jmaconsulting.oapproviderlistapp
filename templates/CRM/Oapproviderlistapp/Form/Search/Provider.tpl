    ...
    <tr>
      <td style="width=50%;">
        <div style="color:#bd3933">
          <font style="float:left;color:#1264A9;font-size:1.8em;font-weight:bold;padding-top:5px;" class="{if $row.accepting_new_clients__63 eq 0}not-accepting{/if} provider-title">{$row.first_name} {$row.last_name}</font>&nbsp;&nbsp;&nbsp;
