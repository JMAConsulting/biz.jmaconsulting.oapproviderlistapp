              ...
              <tr class="crm-contact-custom-search-form-row-{$element}">
                ...
                {else}
                  <td style="width:10%;text-align:right;">
                    {$form.$element.label}{if $element eq 'region'}&nbsp;&nbsp;<a title="{ts}Click for map of regions{/ts}" href="/sites/default/files/images/2020-02/autismonatio-regions-feb.jpg" class="crm-image-popup"><i class="crm-i fa-map-marker"></i></a>{/if}
                  </td>
