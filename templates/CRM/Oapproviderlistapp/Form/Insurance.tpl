<div class="crm-public-form-item crm-section sectorcheck">
  ...
  {if $custom_57_file.displayURL}
   <div class="file-attachment-57">
      <div class="crm-section file_displayURL-section file_displayURL-section"><div class="content">{ts}Uploaded file:{/ts} <a href="{$custom_57_file.displayURL}">{$custom_57_file.name}</a></div></div>
...
CRM.$(function($) {
  ...
  $('.file-attachment-57').insertAfter('#editrow-custom_57');
