...
function _oapproviderlistapp_civix_civicrm_managed(&$entities) {
  ...
  foreach ($mgdFiles as $file) {
    ...
    foreach ($es as $e) {
      if (empty($e['module'])) {
        $e['module'] = 'biz.jmaconsulting.oapproviderlistapp';
      }
      $entities[] = $e;
    }
  }
...
function _oapproviderlistapp_civix_civicrm_caseTypes(&$caseTypes) {
  ...
  foreach (_oapproviderlistapp_civix_glob(__DIR__ . '/xml/case/*.xml') as $file) {
    ...
    $caseTypes[$name] = array(
      'module' => 'biz.jmaconsulting.oapproviderlistapp',
      'name' => $name,
      'file' => $file,
    );
  }
 ...
 */
function _oapproviderlistapp_civix_insert_navigation_menu(&$menu, $path, $item, $parentId = NULL) {
  static $navId;
